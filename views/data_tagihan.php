...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <h1 class="mt-4 mb-4 text-center text-danger">Data Tagihan Air</h1>
            <span id="message"></span>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col col-sm-9">Data tagihan</div>
                        <div class="col col-sm-3">
                            <button type="button" id="add_data" class="btn btn-success btn-sm float-end">Tambahkan</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        for (var i = 0; i < json.length; i++) {
                            var sub_array = {
                                ...
                                'action' : '<button onclick="showOne('+json[i].id+')" class="btn btn-sm btn-warning me-2">Edit</button>'+
                                            '<button onclick="deleteOne('+json[i].id+')" class="btn btn-sm btn-danger">Hapus</button>'  
                            };
